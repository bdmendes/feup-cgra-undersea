...
import { MyComplexTriangle } from "./MyComplexTriangle.js";
...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.objects = [this.plane, this.pyramid, this.cone, this.cube, this.tangram, this.quad, this.unitCubeQuad, this.complexTriangle];

        // Labels and ID's for object selection on MyInterface
        this.objectIDs = { 'Plane': 0 , 'Pyramid': 1, 'Cone': 2, 'Cube': 3, 'Tangram':4, 'Quad':5, 'Cube Quad': 6, 'Complex Triangle':7};
