...
export class MyCylinder extends CGFobject {
    ...
    constructor(scene, slices, deep) {
        ...
        //this.material.setTexture(new CGFtexture(this.scene, 'images/part-a/test_cylinder/fade.png'));
        //this.material.setTexture(new CGFtexture(this.scene, 'images/part-a/default.png'));
        //this.material.setTexture(new CGFtexture(this.scene, 'images/part-a/earth.jpg'));
        //this.material.setTexture(new CGFtexture(this.scene, 'images/part-a/test_cubemap/nx.png'));
        this.material.setTexture(new CGFtexture(this.scene, 'images/part-a/test_cylinder/soup.jpg'));
